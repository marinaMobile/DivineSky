...
import com.hagstrom.h.ApppClass.Companion.AF_DEV_KEY
import com.hagstrom.h.ApppClass.Companion.C1
import com.hagstrom.h.ApppClass.Companion.D1
import com.hagstrom.h.ApppClass.Companion.jsoupCheck
import com.hagstrom.h.ApppClass.Companion.linkAppsCheckPart1
import com.hagstrom.h.ApppClass.Companion.linkAppsCheckPart2
import com.hagstrom.h.ApppClass.Companion.linkFilterPart1
import com.hagstrom.h.ApppClass.Companion.linkFilterPart2
import com.hagstrom.h.ApppClass.Companion.odone
import com.hagstrom.h.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private suspend fun mover(){
        ...
        if (jsoup == jsoupCheck) {
            Intent(applicationContext, Gammmm::class.java).also { startActivity(it) }
        } else {
            Intent(applicationContext, Weeeeb::class.java).also { startActivity(it) }
        }
        finish()
    }
