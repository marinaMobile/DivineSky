...
import com.hagstrom.h.ApppClass.Companion.MAIN_ID
...
class Weeeeb : AppCompatActivity() {
    ...
    lateinit var bind: ActivityWeeeebBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        bind = ActivityWeeeebBinding.inflate(layoutInflater)
...
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun getUrl(): String {
        ...
        val first = "http://"
        val second = "divinesky.live/go.php?to=2&"
